...
public class DefaultExceptionListener extends ExceptionListenerAdapter {
    ...
    public void onEventException(Exception e, List<Object> args, SocketIOClient client) {
        log.warn("EventException:" + e.getMessage(), e);
    }

    @Override
    public void onDisconnectException(Exception e, SocketIOClient client) {
        log.warn("DisconnectException:" +e.getMessage(), e);
    }

    @Override
    public void onConnectException(Exception e, SocketIOClient client) {
        log.warn("ConnectEventException:" +e.getMessage(), e);
    }

    @Override
    public void onMessageException(Exception e, String data, SocketIOClient client) {
        log.warn("MessageException:" +e.getMessage(), e);
    }

    @Override
    public void onJsonException(Exception e, Object data, SocketIOClient client) {
        log.warn("JsonException:" +e.getMessage(), e);
    }
